...
<#--                                <td><input type="checkbox"/></td>-->
                ...
                <ul class="am-pagination am-fr">
                    ...
                    <#else>
                        <li class="am-disabled"><a href="/manager/driver/findByStatus?status=0&page=${currentPage-1}&size=${size}">«</a></li>
                    </#if>
                    ...
                    <#else>
                        <#list 1..drivers.getTotalPages() as index>
                            ...
                            <#else>
                                <li class="am-disabled"><a href="/manager/driver/findByStatus?status=0&page=${index}&size=${size}">${index}</a></li>
                            </#if>
                        </#list>
                    </#if>
